...
function trackRow(release, artist, artistReleases = []) {
      ...
      <div class="music-release-artwork">
        ...
        ${
          canPlayComplimentaryRelease(release)
            ? `<button class="artwork-play-button artwork-play-button-square" type="button" data-artwork-play aria-label="Play ${title}">▶ Play</button>`
            : ""
        }
      </div>
  ...
  attachArtworkPlayer(row.querySelector("[data-artwork-play]"), release, artist);
